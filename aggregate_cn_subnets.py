...
for subnet in merged_subnets:
    #while subnet.prefixlen > CIDR_THRESHOLD:
    #    supernets = list(subnet.supernet())  # Genereer supernet
    #    if len(supernets) == 1 and supernets[0].prefixlen >= CIDR_THRESHOLD:
    #        subnet = supernets[0]  # Vergroot subnet
    #    else:
    #        break  # Stop als er meerdere opties zijn of we onder de drempel gaan
